...
namespace Glyph.Transition
{
    public class TransitionColor : ITransition<Color>
    {
        ...
        public float Duration { get { return _transitionFloat.Duration; } set { _transitionFloat.Duration = value; } }
        public float MeanSpeed { set { _transitionFloat.MeanSpeed = value; } }
        public float Delay { get { return _transitionFloat.Delay; } set { _transitionFloat.Delay = value; } }
        public Color Value { get { return _value; } }
        public float ElapsedTime { get { return _transitionFloat.ElapsedTime; } }
        public bool IsEnd { get { return _transitionFloat.IsEnd; } }
        public bool IsWaiting { get { return _transitionFloat.IsWaiting; } }
