...
namespace Glyph
{
    ...
    static public class Camera
    {
        ...
        static public void Update(GameTime gameTime, Vector2 center, ISpace space = null)
        {
            Vector2 sizeSpace = space != null ? space.Size : Vector2.Zero;
            ...
            switch (Mode)
            {
                case CameraMode.Auto:
                    if (IsAdaptToEdges && sizeSpace != Vector2.Zero)
                        Center = CorrectionEdges(center + Relative, sizeSpace);
                    else
                ...
                case CameraMode.Script:
                    if (IsAdaptToEdges && sizeSpace != Vector2.Zero)
                    {
                        Destination = CorrectionEdges(Destination, sizeSpace);
                        Center = CorrectionEdges(Center, sizeSpace);
                    }
