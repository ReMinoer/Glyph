...
namespace Glyph.Tools.Brushing
{
    ...
    {
        static public IBrush<TCanvasOut, TArgsOut, TPaint> Target<TCanvasIn, TCanvasOut, TArgsIn, TArgsOut, TPaint>(this IBrush<TCanvasIn, TArgsIn, TPaint> brush, Func<TCanvasOut, TCanvasIn> targetSelector, Func<TCanvasOut, TArgsOut, TArgsIn> argsFunc)
